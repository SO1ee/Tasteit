			...
			<div class="row justify-content-between">
				...
				<div class="col-12 col-md d-flex justify-content-md-end">
					...
					<div class="social-media">
						<p class="mb-0 d-flex">
							<a href="#" class="d-flex align-items-center justify-content-center"><span><i class="fa-brands fa-facebook-f"></i></span></a>
							<a href="#" class="d-flex align-items-center justify-content-center"><span><i class="fa-brands fa-twitter"></i></span></a>
							<a href="#" class="d-flex align-items-center justify-content-center"><span><i class="fa-brands fa-instagram"></i></span></a>
						</p>
					</div>
				</div>
			</div>
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					if(isset($_SESSION["username"])){
						...
						$sql2="SELECT * FROM orderr";
						$result2=mysqli_query($con,$sql2) or die("query failed");
						$row2=mysqli_num_rows($result2);
						echo'<li class="nav-item"><a href="#" class="nav-link"><i class="fa-solid fa-user"></i>',$_SESSION["username"],'</a></li>';
						echo'<li class="nav-item"><a href="logout.php" class="nav-link"><i class="fa-solid fa-right-from-bracket"></i></a></li>';
						echo'<li class="nav-item"><a href="mycart.php" class="nav-link"><i class="fa-solid fa-cart-shopping"></i><sup>';echo $row2;echo'</sup></a></li>';
					}else{
						echo'<li class="nav-item"><a href="login.php" class="nav-link"><i class="fa-solid fa-user"></i></a></li>';
					}
					?>
				</ul>
			</div>
								...
								<div class="container">
  									<div class="row row-cols-4">
										<?php
											...
											echo'<div class="col">
											<div class="card menu-img img" style="width: 15rem;height:28rem;">
									  		<img src="images/';echo  $row['img'];echo'" class="card-img-top" alt="...">
									  		<div class="card-body">
											<h5 class="card-title">';echo $row['name'];echo'</h5>
											<p class="card-text">';echo $row['type'];echo'&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;';echo $row['price'];echo'</p>';
											if(isset($_SESSION["username"])){
												echo'<a href="order.php?id=';echo $row['pid'];echo'"><button type="button" name="order" class="btn btn-danger">Order Now</button></a>';
											}else{
												echo'<a href="login.php"><button type="button" name="order" class="btn btn-danger">Order Now</button></a>';
											}
