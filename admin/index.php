...
<table>
  ...
  <tbody>
    ...
    echo '<tr>
      ...
      <td><a href=delete.php?id=';echo $row3['pid'];echo'><button type="button" class="btn btn-danger">Delete</button></a></tr>';}}}else{header("Location:{$hostname}/tasteit-master/admin/sign.php");}?>
  </tbody>
</table>
</div>
